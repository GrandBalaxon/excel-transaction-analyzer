...
def test_backlogging_first_call_no_cache(setup_mocks):
...
def test_backlogging_second_call_with_cache(mocker, setup_mocks):
...
def test_backlogging_error_in_key_generation(mocker, setup_mocks):
...
def test_backlogging_json_decode_error(mocker, setup_mocks):
...
def test_backlogging_none_result_not_cached(setup_mocks):
